...
local launcher = "rofi -modi drun,run -show drun"
local windowSwitcher = "rofi -modi window -show window"
...
-- end)
hl.on("hyprland.start",function()
    hl.exec_cmd("eww -c $HOME/.config/eww open-many bar notifications")
    hl.exec_cmd("fcitx5-remote -r")
    hl.exec_cmd("fcitx5 -d --replace")
    hl.exec_cmd("wl-paste --type text --watch cliphist store")
    hl.exec_cmd("wl-paste --type image --watch cliphist store")
    hl.exec_cmd("awww-daemon")
    hl.exec_cmd("zsh -c 'sleep 1 && awww img $HOME/pictures/wallpaper/yofukashi_size4.jpg'")
end)
...
hl.bind("SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region -z -o " .. screenshotDir))
...
--IME Reset
hl.bind(mainMod .. " + SHIFT + I", hl.dsp.exec_cmd("fcitx5 -r -d"))
